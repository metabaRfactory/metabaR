...
devtools::install_github("metabaRactory/metabaR")
```
...
As for above, *pcrs* containing large amounts of MOTUs identified as potentially artifactual or where tag-jumps filtering strongly affects the number of reads in *pcrs* can be flagged as potentially dysfunctional. 
