...
The variability across sites is hence far larger than between samplers and technical replicates. But the sampler effect is not negligible. 

# Data final cleaning and aggregation

We refer to the tutorial using the `soil_euk` dataset for these last steps.
