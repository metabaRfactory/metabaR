...
#' @param replicates   a factor of sample names to which replicates belongs to (i.e. should be a prefix/suffix of pcr replicates names)
#' @param control   a character vector indicating the names of experimental controls against which PCRs replicates are to be compared.
#' @param thresh.method   a character indicating what method should be used to define the filtering threshold.
#' @param plot    a boolean indicating weither dissimilarity distribution should be plotted. Default is \code{TRUE}
