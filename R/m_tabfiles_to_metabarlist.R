...
#'
#' Importing and formatting four files (corresponding to MOTUs abundances, MOTUs characteristics, PCRs characteristics and samples characteristics respectively) to create a \code{\link{metabarlist}} object.
#'
#'
